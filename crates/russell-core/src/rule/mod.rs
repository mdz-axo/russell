...
fn default_rules() -> Vec<Rule> {
    vec![
        Rule {
            probe: "mem_available_mib".into(),
            description: Some("Available system memory".into()),
            unit: Some("MiB".into()),
            warn_below: Some(4096.0),
            alert_below: Some(2048.0),
            crit_below: Some(1024.0),
            warn_above: None,
            alert_above: None,
            crit_above: None,
        },
Rule {
        ...
        Rule {
            ...
            description: Some("1-minute load average".into()),
            unit: None,
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(8.0),
            alert_above: Some(16.0),
            crit_above: Some(32.0),
        },
        Rule {
            probe: "proc_total_count".into(),
            description: Some("Total running processes".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(500.0),
            alert_above: Some(800.0),
            crit_above: Some(1200.0),
        },
        Rule {
            probe: "proc_zombie_count".into(),
            description: Some("Zombie (defunct) processes".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(5.0),
            alert_above: Some(20.0),
            crit_above: Some(50.0),
        },
        Rule {
            probe: "proc_stuck_count".into(),
            description: Some("Processes in uninterruptible sleep".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(10.0),
            alert_above: Some(30.0),
            crit_above: Some(100.0),
        },
        Rule {
            probe: "proc_running_count".into(),
            description: Some("Processes currently on the run queue".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(16.0),
            alert_above: Some(32.0),
            crit_above: Some(64.0),
        },
        Rule {
            probe: "proc_top_mem_pct".into(),
            description: Some("Memory usage of largest process".into()),
            unit: Some("%".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(25.0),
            alert_above: Some(50.0),
            crit_above: Some(75.0),
        },
        Rule {
            probe: "gpu_vram_used_pct".into(),
            description: Some("dGPU VRAM usage".into()),
            unit: Some("%".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
        ...
        Rule {
            probe: "gpu_temp_c".into(),
            description: Some("dGPU temperature".into()),
            unit: Some("°C".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
        ...
        Rule {
            probe: "gpu_vram_used_mib".into(),
            description: Some("dGPU VRAM used".into()),
            unit: Some("MiB".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
        ...
        Rule {
            probe: "gpu_vram_total_mib".into(),
            description: Some("dGPU total VRAM".into()),
            unit: Some("MiB".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
        ...
        Rule {
            probe: "gpu_util_pct".into(),
            description: Some("dGPU compute utilisation".into()),
            unit: Some("%".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(90.0),
            alert_above: Some(95.0),
            crit_above: Some(98.0),
        },
        Rule {
            probe: "disk_io_pressure_some_pct".into(),
            description: Some("I/O pressure — some tasks stalled".into()),
            unit: Some("%".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
        ...
        Rule {
            probe: "systemd_degraded".into(),
            description: Some("Systemd degraded state".into()),
            unit: Some("bool".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(0.5),
            alert_above: Some(0.5),
            crit_above: Some(0.5),
        },
        Rule {
            probe: "systemd_user_failed_count".into(),
            description: Some("Failed user systemd units".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
        ...
        Rule {
            probe: "systemd_system_failed_count".into(),
            description: Some("Failed system systemd units".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
        ...
        Rule {
            probe: "okapi_tokens_per_sec".into(),
            description: Some("Okapi token generation throughput".into()),
            unit: Some("t/s".into()),
            warn_below: Some(5.0),
            alert_below: Some(2.0),
            crit_below: Some(1.0),
            warn_above: None,
            alert_above: None,
            crit_above: None,
        ...
        Rule {
            probe: "okapi_gpu_memory_used_pct".into(),
            description: Some("Okapi model GPU memory usage".into()),
            unit: Some("%".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(85.0),
            alert_above: Some(95.0),
            crit_above: Some(98.0),
        },
        Rule {
            probe: "okapi_goroutine_count".into(),
            description: Some("Okapi server goroutine count".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(200.0),
            alert_above: Some(500.0),
            crit_above: Some(1000.0),
        },
        Rule {
            probe: "okapi_errors_total".into(),
            description: Some("Okapi inference errors since start".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(1.0),
            alert_above: Some(10.0),
            crit_above: Some(50.0),
        },
        Rule {
            probe: "okapi_adapter_count".into(),
            description: Some("Loaded LoRA adapters".into()),
            unit: Some("count".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(4.0),
            alert_above: Some(8.0),
            crit_above: Some(12.0),
        },
        Rule {
            probe: "okapi_uptime_hours".into(),
            description: Some("Okapi server uptime".into()),
            unit: Some("hours".into()),
            warn_below: None,
            alert_below: None,
            crit_below: None,
            warn_above: Some(24.0),
            alert_above: Some(72.0),
            crit_above: Some(168.0),
        },
    ]
}
