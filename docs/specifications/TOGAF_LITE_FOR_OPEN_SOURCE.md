...
| `docs/archive/` | Architecture Repository | Provenance-tracked archive for superseded documents |
...
*This pattern specification is maintained as part of the Peripheral documentation corpus. It is designed to be self-contained and reusable by other open-source projects. For the Peripheral-specific implementation details, see [`docs/architecture/README.md`](README.md) v2.0.0 and [`docs/README.md`](../README.md) v2.0.0. Pattern updated 2026-04-15 to reflect ~35 active files, 3 accepted ADRs, 17 crates in 1 workspace, Standard-tier TOGAF-Lite adoption, and the Gentle/Hackos documentation philosophy (§7).*
